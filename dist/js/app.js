...
var normalizeLink = __webpack_require__(85);
...
var _article3 = __webpack_require__(138);

var _article4 = _interopRequireDefault(_article3);

var _article5 = __webpack_require__(139);
...
var _reactRouterScroll = __webpack_require__(80);
...
var _index7 = __webpack_require__(334);

var _index8 = _interopRequireDefault(_index7);

var _index9 = __webpack_require__(341);

var _index10 = _interopRequireDefault(_index9);

var _index11 = __webpack_require__(340);

var _index12 = _interopRequireDefault(_index11);

var _index13 = __webpack_require__(338);
...
var _index17 = __webpack_require__(339);

var _index18 = _interopRequireDefault(_index17);

var _index19 = __webpack_require__(342);
...
(0, _reactDom.render)(_react2.default.createElement(
  ...
  _react2.default.createElement('route', { path: '/write', component: _index20.default })
...
var ParserBlock  = __webpack_require__(165);
var ParserInline = __webpack_require__(167);
...
var config = {
  ...
  'full':       __webpack_require__(163),
  'commonmark': __webpack_require__(161)
};
...
var _rules = [
  ...
  [ 'fences',     __webpack_require__(173),     [ 'paragraph', 'blockquote', 'list' ] ],
  [ 'blockquote', __webpack_require__(170), [ 'paragraph', 'blockquote', 'list' ] ],
  [ 'hr',         __webpack_require__(176),         [ 'paragraph', 'blockquote', 'list' ] ],
  [ 'list',       __webpack_require__(179),       [ 'paragraph', 'blockquote' ] ],
  [ 'footnote',   __webpack_require__(174),   [ 'paragraph' ] ],
  [ 'heading',    __webpack_require__(175),    [ 'paragraph', 'blockquote' ] ],
  [ 'lheading',   __webpack_require__(178) ],
  [ 'htmlblock',  __webpack_require__(177),  [ 'paragraph', 'blockquote' ] ],
  [ 'table',      __webpack_require__(182),      [ 'paragraph' ] ],
  [ 'deflist',    __webpack_require__(172),    [ 'paragraph' ] ],
  [ 'paragraph',  __webpack_require__(180) ]
];
...
var _rules = [
  [ 'block',          __webpack_require__(185)          ],
  [ 'abbr',           __webpack_require__(183)           ],
  [ 'references',     __webpack_require__(189)     ],
  [ 'inline',         __webpack_require__(187)         ],
  [ 'footnote_tail',  __webpack_require__(186)  ],
  [ 'abbr2',          __webpack_require__(184)          ],
...
var Ruler       = __webpack_require__(39);
var StateInline = __webpack_require__(49);
...
var _rules = [
  [ 'text',            __webpack_require__(207) ],
  [ 'newline',         __webpack_require__(204) ],
  [ 'escape',          __webpack_require__(197) ],
  [ 'backticks',       __webpack_require__(193) ],
  [ 'del',             __webpack_require__(194) ],
  [ 'ins',             __webpack_require__(201) ],
  [ 'mark',            __webpack_require__(203) ],
  [ 'emphasis',        __webpack_require__(195) ],
  [ 'sub',             __webpack_require__(205) ],
  [ 'sup',             __webpack_require__(206) ],
  [ 'links',           __webpack_require__(202) ],
  [ 'footnote_inline', __webpack_require__(198) ],
  [ 'footnote_ref',    __webpack_require__(199) ],
  [ 'autolink',        __webpack_require__(192) ],
  [ 'htmltag',         __webpack_require__(200) ],
...
var block_names = __webpack_require__(158);
...
var Autolinker = __webpack_require__(128);
...
var StateInline          = __webpack_require__(49);
var parseLinkLabel       = __webpack_require__(38);
var parseLinkDestination = __webpack_require__(87);
var parseLinkTitle       = __webpack_require__(88);
var normalizeReference   = __webpack_require__(86);
...
var url_schemas   = __webpack_require__(160);
var normalizeLink = __webpack_require__(85);
...
var HTML_TAG_RE = __webpack_require__(159).HTML_TAG_RE;
...
var _remarkable = __webpack_require__(157);
...
var _article = __webpack_require__(136);

var _article2 = _interopRequireDefault(_article);

var _articleRelate = __webpack_require__(135);
...
var ArticleDetail = function (_Component) {
  ...
  _createClass(ArticleDetail, [{
    ...
    value: function render() {
      ...
      var content = { __html: md.render(this.state ? this.state.article_content : '123456789') };
      return _react2.default.createElement(
        'div',
        ...
        _react2.default.createElement('div', { className: 'ArticleDetail_content', dangerouslySetInnerHTML: content }),
...
var Write = function (_Component) {
  ...
  _createClass(Write, [{
    ...
    value: function handelSubmit(e) {
      console.log(1);
      var data = (0, _jquery2.default)('form').serialize();
      console.log(data);
      _jquery2.default.ajax({
        url: '/api/write',
        type: 'post',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'write_line' },
            _react2.default.createElement(
              'label',
              { htmlFor: 'title' },
              'title'
            ),
            _react2.default.createElement('input', { type: 'text', classID: 'title', name: 'title' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'write_line' },
            ...
            _react2.default.createElement('input', { type: 'text', classID: 'author', name: 'author' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'write_line' },
            ...
            _react2.default.createElement('textarea', { type: 'text', classID: 'content', name: 'content' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'write_line' },
            _react2.default.createElement(
              'a',
              { className: 'submit', href: 'javascript:;', onClick: function onClick(e) {
                  return _this2.handelSubmit(e);
                } },
              'submit'
            )
          )
